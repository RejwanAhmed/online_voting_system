...
?>
<?php
    if(isset($_POST['view_ballot']) AND isset($_GET['id']) AND isset($_GET['ballot_no']))
    {
        $qry = "SELECT * FROM `ballot` WHERE `id` = '$_GET[id]'";
    ...
    <div class="container-fluid mb-3" >
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6">
                <button type = "button" class = " form-control mt-3 btn btn-danger font-weight-bold" id  = "download"><b><span><i class="fas fa-download"></i></span> Download Ballot </b></button>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class = "col-lg-6 card" id = "election_name_year">
                <div class="card-body text-center">
                    ...
                    <h5><?php echo "Ballot No = $_GET[ballot_no]" ?></h5>
                </div>
            </div>
        </div>
        <div>
                            ...
                            <div class="form-group card-body ">
                                <?php
                                    ...
                                    for($j=0;$j<sizeof($col_value_array);$j++)
                                    {
                                        ...
                                        if($str=="You Have Not Voted To Anyone")
                                        {
                                            echo "<table class = 'table table-bordered text-center'>";
                                                ...
                                                echo "<tr>";
                                                    echo "<td><h5 class = 'text-danger'><b>$str</b></h5></td>";
                                                echo "</tr>";
                                            echo "</table>";
                                        }
                                        else
