<?php
    ...
    if(isset($_GET['id']))
    {
        ...
        $id_validation_qry = "SELECT * FROM `department` WHERE `id` = '$_GET[id]'";
    ...
    $delete_qry = "DELETE FROM `department` where `id` = '$_GET[id]'";
    ...
    if($delete_qry_run)
    {
        ...
        <script type="text/javascript">
        	...
        	window.location = "view_department.php?page=<?php echo $page; ?>";
        </script>
        <?php
    }
?>
