...
<div class="container-fluid">
    <div class="row justify-content-center" style = "text-align:center">
        <div class = "col-lg-10 col-sm-10 col-10">
            <div class = "view_information">
                <h4 class = "text-uppercase"><b>Email Information For Sending Confirmation</b><i class="fa fa-list-alt info_details ml-2" aria-hidden="true"></i></h4>
            </div>
        </div>
    </div>
    ...
    <?php
    $select_admin_email_sending_confirmation_qry = "SELECT * FROM `admin_email_sending_confirmation`";
    ...
    <div class="row justify-content-center mt-2" style = "text-align:center">
        <div class="col-lg-12 col-12">
            <table class = "table table-bordered table-hover">
                ...
                <?php
                    $i=1;
                    while($row = mysqli_fetch_assoc($select_admin_email_sending_confirmation_qry_res))
                    {
                        ...
                        echo "<tr>";
                            ...
                            echo "<td>$email</td>";
                            echo "<td>$pass</td>";
                            echo "<td><a class = 'btn btn_color' href='delete_admin_email_sending_confirmation.php?id=$row[id]'><b><span><i class='fas fa-eraser'></i></span> Remove</b></a></td>";
                        echo "</tr>";
                        $i++;
                    }
                ?>
    ...
    if(isset($_POST['submit']))
    {
        ...
        else
        {
            ...
            if($select_admin_email_sending_id_qry_res_row)
            {
                ?>
                <script>
                    document.getElementById("email").innerHTML = "Email Address Already Exist In Admin Email Sending ID";
                </script>
                <?php
                exit();
            }
            ...
            {
                $insert_admin_email_qry = "INSERT INTO `admin_email_sending_confirmation`(`email`,`password`) VALUES ('$email','$pass')";
